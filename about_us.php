        ...
        <section class="col-main col-sm-12">
          ...
          <div id="contact" class="page-content page-contact">
            ...
            <div id="message-box-conact">Find Us...</div>
                <br/>
                <ul class="store_info">
                  <li><i class="fa fa-home"></i>Nairobi Kenya P.O BOX&nbsp;23030-00604</li>
          ...
          <div class="page-title">
            ...
            <div>
                <p style="color:darkslateblue">  We have been established as a software development company based in western Kenya. We boast of proven ability for development
                    of high-performance software solutions. We believe in innovation, best practices, employee recognition and delivering high levels
                    of customer satisfaction. As a show of commitment to innovation we consistently provide our customers with new enhancements to confirm a solid dedication to help them achieve success.
                </p>
               ...
               <h4>Vision</h4>
                    ...
                    equal opportunity to all while improving the livelihood of the society.
                      ...
                      <p>To achieve excellence in knowledge dissemination, development and implementation of Computing and Information and Communication Technologies through quality teaching, research,
                       ...
                       <h4>Core Values</h4>
                      <p>In order to achieve our vision and execute our mission, TrixTechnologies upholds the following values;</p>
